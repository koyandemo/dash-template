...
const MyCard = ({ user_name, user_title }: CardType) => {
  ...
  return (
    <div className="flex justify-center items-center w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
