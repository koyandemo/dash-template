...
const MyNewCard = () => {
  return (
    <div className="w-[280px] h-[355px] flex flex-col gap-5 items-center justify-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 cursor-pointer">
